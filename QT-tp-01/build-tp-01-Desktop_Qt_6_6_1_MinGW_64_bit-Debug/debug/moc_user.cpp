...
Q_CONSTINIT static const qt_meta_stringdata_CLASSUserENDCLASS_t qt_meta_stringdata_CLASSUserENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(5, 22),  // "purchaseHistoryChanged"
        QT_MOC_LITERAL(28, 0),  // ""
        QT_MOC_LITERAL(29, 22)   // "displayPurchaseHistory"
    },
    "User",
    "purchaseHistoryChanged",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSUserENDCLASS[] = {
 ...
 // methods: name, argc, parameters, tag, flags, initial metatype offsets
       3,    0,   27,    2, 0x102,    2 /* Public | MethodIsConst  */,
...
Q_CONSTINIT const QMetaObject User::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSUserENDCLASS_t,
        ...
        // method 'purchaseHistoryChanged'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'displayPurchaseHistory'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void User::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->purchaseHistoryChanged(); break;
        case 1: _t->displayPurchaseHistory(); break;
        default: ;
        }
        ...
        {
            using _t = void (User::*)();
            if (_t _q_method = &User::purchaseHistoryChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void User::purchaseHistoryChanged()
{
...
static constexpr auto qt_meta_stringdata_CLASSUserListENDCLASS = QtMocHelpers::stringData(
    "UserList",
    "userListChanged",
    ""
);
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSUserListENDCLASS_t qt_meta_stringdata_CLASSUserListENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(9, 15),  // "userListChanged"
        QT_MOC_LITERAL(25, 0)   // ""
    },
    "UserList",
    "userListChanged",
...
void UserList::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &UserList::userListChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
