...
Q_CONSTINIT static const qt_meta_stringdata_CLASSVehicleENDCLASS_t qt_meta_stringdata_CLASSVehicleENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(8, 13),  // "errorOccurred"
        QT_MOC_LITERAL(22, 0),  // ""
        QT_MOC_LITERAL(23, 12)   // "errorMessage"
    },
    "Vehicle",
    "errorOccurred",
    "",
...
void Vehicle::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Vehicle::errorOccurred; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Vehicle::errorOccurred(const QString & _t1)
{
